...
package OpenCV.Core.Float16_Vec3_Buffer_Access is
   ...
   --  three native Float16 channels. Each component is the exact stored
   ...
   --  callback. Data is a flat zero-based row-major array of Mat
   --  pixels: Data'First = 0, Data'Last = Natural (Image.Total) - 1,
   --  and Data'Length = Natural (Image.Total). Element
