package OpenCV.Core.Int16_Row_Access is

   subtype Column_Index is Natural;

   type Row_Array is array (Natural range <>) of Int16_Value;
   ...
   --  Invokes Process with a zero-copy view of one Int16 C1 Mat row.
