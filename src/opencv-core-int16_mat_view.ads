package OpenCV.Core.Int16_Mat_View is

   type Buffer_Array is array (Natural range <>) of Int16_Value;

   --  Invokes Process with a temporary writable CV_16SC1 Mat that aliases
   ...
   --  CV_16SC1 Mat that aliases Data. Shape'Length must be in 2 .. 32 and
   ...
   --  Invokes Process with a temporary writable CV_16SC1 Mat that aliases
   --  Data with Row_Stride Int16 elements between logical row starts.
