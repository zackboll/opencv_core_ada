package OpenCV.Core.UInt16_Row_Access is

   subtype Column_Index is Natural;

   type Row_Array is array (Natural range <>) of UInt16_Value;
   ...
   --  Invokes Process with a zero-copy view of one UInt16 C1 Mat row.
