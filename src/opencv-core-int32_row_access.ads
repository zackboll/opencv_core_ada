package OpenCV.Core.Int32_Row_Access is

   subtype Column_Index is Natural;

   type Row_Array is array (Natural range <>) of Int32_Value;
   ...
   --  Invokes Process with a zero-copy view of one Int32 C1 Mat row.
