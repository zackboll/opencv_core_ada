package OpenCV.Core.Float64_Row_Access is

   subtype Column_Index is Natural;

   type Row_Array is array (Natural range <>) of Float64_Value;
   ...
   --  Invokes Process with a zero-copy view of one Float64 C1 Mat row.
